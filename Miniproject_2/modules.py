...
class TransposeConv2d(Module):
    ...
    def backward(self, gradwrtoutput):
        ...
        #print('weighhhhhhhhttttttttttttttttttt graaaaaaaaaaaaaaaadd',self.dw.shape)
...
class SGD():
    ### Stochastic Gradient Descent to match in Sequential
    ...
    def step(self):
        ...
        for param in self.param:
            val, grad = param
            #print('paraaaaaaaaaaaaaaaaaaaaaaammm',param)
            val.add_(-self.eta*grad)
            print('graaaaaaaaaaaaaaaaaadddddddddddd',grad)
            self.param=val, grad
